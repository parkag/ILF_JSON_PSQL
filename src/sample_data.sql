...
INSERT INTO "SERIE" ("sesja_id", "data", "wynik") VALUES
(1, now(), '{ "betaArray": {"value": [3, 4, 5], "pragma": "append"}, "constants": {"value": [2.73], "pragma": "append"}}');
INSERT INTO "SERIE" ("sesja_id", "data", "wynik") VALUES
(1, now(), '{ "betaArray": {"value": [6, 7, 8], "pragma": "append"}, "constants": {"value": [3.1415, 1], "pragma": "replace"}}');
INSERT INTO "SERIE" ("sesja_id", "data", "wynik") VALUES
